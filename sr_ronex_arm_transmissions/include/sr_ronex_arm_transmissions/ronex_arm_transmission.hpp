...
#ifndef _RONEX_ARM_TRANSMISSION_H_
#define _RONEX_ARM_TRANSMISSION_H_
...
namespace ronex
{
  class RonexArmTransmission : public pr2_mechanism_model::Transmission
  {
  public:
    RonexArmTransmission() {};
    virtual ~RonexArmTransmission() {};
...
#endif /* _RONEX_ARM_TRANSMISSION_H_ */
